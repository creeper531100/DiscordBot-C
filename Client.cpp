            ...
            if (m_commands.find(cmd) != m_commands.end()) {
                ...
                if (arg_count < 0) {
                    ...
                    if (argv.size() < arg_count) {
                        sendMessage(message.channelID, u8"把计びぶ");
                        return;
                    }
                ...
                if (arg_count + 1 == argv.size()) {
                    ...
                    sendMessage(message.channelID, u8"把计岿粇");
                }

            }
            else {
                sendMessage(message.channelID, u8"⊿Τ");
            }
        }
    }
